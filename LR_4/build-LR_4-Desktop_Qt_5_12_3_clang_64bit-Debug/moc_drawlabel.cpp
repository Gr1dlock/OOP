...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DrawLabel_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject DrawLabel::staticMetaObject = { {
    &QLabel::staticMetaObject,
    qt_meta_stringdata_DrawLabel.data,
    qt_meta_data_DrawLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *DrawLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DrawLabel.stringdata0))
