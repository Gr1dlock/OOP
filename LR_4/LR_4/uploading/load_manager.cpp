...
LoadManager::LoadManager(BaseLoader *loader)
    : _loader(loader), _builder(new ModelBuilder())
{}

std::shared_ptr<objects::Model> LoadManager::loadModel(std::string source_name, std::string model_name)
{
