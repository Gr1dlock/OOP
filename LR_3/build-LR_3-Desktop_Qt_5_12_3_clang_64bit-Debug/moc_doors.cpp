...
QT_MOC_LITERAL(4, 29, 11), // "closedDoors"
QT_MOC_LITERAL(5, 41, 10), // "closeDoors"
QT_MOC_LITERAL(6, 52, 9), // "openDoors"
QT_MOC_LITERAL(7, 62, 12), // "openingDoors"
QT_MOC_LITERAL(8, 75, 12) // "closingDoors"

    },
    "Doors\0statusChanged\0\0message\0closedDoors\0"
    "closeDoors\0openDoors\0openingDoors\0"
    "closingDoors"
};
...
void Doors::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->closedDoors(); break;
        case 2: _t->closeDoors(); break;
        case 3: _t->openDoors(); break;
        case 4: _t->openingDoors(); break;
        case 5: _t->closingDoors(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Doors::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Doors::statusChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Doors::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Doors::closedDoors)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Doors::statusChanged(QString _t1)
{
