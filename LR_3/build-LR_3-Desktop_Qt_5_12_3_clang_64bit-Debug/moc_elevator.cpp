...
QT_MOC_LITERAL(1, 9, 14), // "forwardMessage"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7), // "message"
QT_MOC_LITERAL(4, 33, 10) // "sendStatus"

    },
    "Elevator\0forwardMessage\0\0message\0"
    "sendStatus"
};
...
void Elevator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->forwardMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->sendStatus((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Elevator::forwardMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Elevator::forwardMessage(QString _t1)
{
